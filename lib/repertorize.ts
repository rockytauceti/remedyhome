...
export async function repertorize(
  ...
  const explanationPhrases = [
    ...
    "Weighing constitutional indicators...",
    "Scanning for keynote symptoms...",
    "Sifting through mental and emotional rubrics...",
    "Comparing acute vs. chronic presentations...",
    "Looking for the totality of symptoms...",
    "Consulting the complete repertory...",
    "Avoiding the side effects...",
    "Skipping the prescription pad...",
    "Working with your body, not against it...",
    "Finding the remedy, not masking the symptoms...",
    "No co-pay needed...",
    "Treating the cause, not the label...",
    "No suppression, just cure...",
    "Leaving the pharmacy out of it...",
